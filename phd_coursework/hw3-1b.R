...
#X <- matrix(rgeom(100000000, 0.3), 1000, 100000)
#X <- rgeom(100000, 0.3)
#plot(X, pch=20, col="mediumpurple3")
...
a100 <- matrix(rhyper(100000, 3, 10, 10), 1000, 100)
b1000 <- matrix(rhyper(1000000, 3, 10, 10), 1000, 1000)
c10000 <- matrix(rhyper(1000000, 3, 10, 10), 1000, 10000)
