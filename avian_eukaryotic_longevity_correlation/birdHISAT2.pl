...
my $runcmd = "cat /usr/local/scratch/CORE/jmccorri/2018/AlignAndCounts.StringTie/trimmed/" . $queryprefix . "_trimmed.S*q > /usr/local/scratch/CORE/jmccorri/2018/AlignAndCounts.StringTie/trimmed/" . $queryprefix . "_trimmed.fragments.fastq";
print "$queryprefix     |\n\t$runcmd";
system("$runcmd");
